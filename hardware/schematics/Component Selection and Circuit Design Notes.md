...
### Power Supply
- In order to cover the ± 2V range, The opamps used in the control loop and the TIA need supply rails sufficient to produce the required output voltages with enough headroom
